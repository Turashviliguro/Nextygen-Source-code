...
?> 
    ...
    <title>Amazon.co.uk - Order </title>
...
<body>
    ...
    <img src='http://media.corporate-ir.net/media_files/IROL/25/251199/Logo2017/Amazon/amazon_co_uk_col_RGB.jpg' width='113' align='left' height='23' border='0'>
    ...
    <table width='90%' border='0' align='center' cellpadding='0' cellspacing='0'>
        ...
        <tr>
            <td valign='top' align='left'>
                <b> Amazon.co.uk order number: </b> <?php echo $z ?>            </td>
                    ...
                    <tbody><tr bgcolor='#ffffff'>
                        <td valign='top' colspan='2'>
                            <table width='100%' border='0' cellspacing='0' cellpadding='5'>
                                <tbody><tr bgcolor='#ffffff'>
                                    <td>
                                        <b class='sans'><center><?php echo $_POST['shipmonth'] . " " . $_POST['shipday'] . ", " . $_POST['shipyear']  ?></center></b>
                                    </td>
                                </tr>
                            </tbody></table>
        ...
        <tbody><tr align='center'>
            <td colspan='2'>
                <font size='-2'>
                    ...
                    <a href='http://www.amazon.com/gp/help/customer/display.html?ie=UTF8&amp;nodeId=468496' rel='nofollow'>Privacy Notice</a>&nbsp;&nbsp;� 1996-<?php echo "20" . date("y"); ?>, Amazon.com, Inc. and its affiliates</font>
            </td>
        </tr>
