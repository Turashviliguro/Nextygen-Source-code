    ...
    <table width='90%' border='0' align='center' cellpadding='0' cellspacing='0'>
        ...
        <tr>
            <td valign='top' align='left'>
                <b>
     Order Total:
     <nobr>$<?php echo number_format($price+$price*$_POST['tax']/100,2) ?></nobr>
   </b>
            </td>
        </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan='1' valign='top'>
                                                    ...
                                                    <br> <span class='tiny'>
                                                            ...
                                                            Sold by:<?php echo $_POST['soldby'] ?>  <a href="#">(seller profile)</a><br>    
                                                        Condition: New<br></span>
...
<!--
                                        <table border='0' cellpadding='0' cellspacing='1'>
                                            ...
                                            <tr valign='top'>
                                                ...
                                                <td nowrap='nowrap' align='right'>$<?php echo $price*$_POST['tax']/100 ?></td>
                                            </tr>
                                            <tr valign='top'>
                                                <td nowrap='nowrap' align='right'>&nbsp;</td>
                                                <td nowrap='nowrap' align='right'>-----</td>
                                            ...
                                            <tr valign='top'>
                                                ...
                                                <td nowrap='nowrap' align='right'>$<?php echo $price+$price*$_POST['tax']/100 ?></td>
                                            </tr>
                                            <tr valign='top'>
                                                <td nowrap='nowrap' align='right'>&nbsp;</td>
                                                <td nowrap='nowrap' align='right'>-----</td>
                                            ...
                                            <tr valign='top'>
                                                ...
                                                <td nowrap='nowrap' align='right'><b>$<?php echo $price+$price*$_POST['tax']/100 ?></b></td>
                                            </tr>
                                            <tr valign='top'>
                                                <td nowrap='nowrap' align='right'>&nbsp;</td>
                                                <td nowrap='nowrap' align='right'>-----</td>
                            ...
                            <table width='100%' border='0' cellspacing='0' cellpadding='2'>
                                <tbody><tr valign='top'>
                                    <td width='100%'>
                                                ...
                                                <td align='right'>
                                                    <table border='0' cellpadding='0' cellspacing='1'>
                                                        ...
                                                        <tr valign='top'>
                                                            ...
                                                            <td nowrap='nowrap' align='right'>$<?php echo number_format($price*$_POST['tax']/100,2) ?></td>
                                                        </tr>
                                                        <tr valign='top'>
                                                            <td nowrap='nowrap' align='right'>&nbsp;</td>
                                                        ...
                                                        <tr valign='top'>
                                                            <td nowrap='nowrap' align='right'>Total:</td>
                                                            <td nowrap='nowrap' align='right'>$<?php echo number_format($price+$price*$_POST['tax']/100,2) ?></td>
                                                        </tr> -->
                                                        <tr valign='top'>
                                                            <td nowrap='nowrap' align='right'>&nbsp;</td>
                                                        </tr>
                                                        <tr valign='top'>
                                                            ...
                                                            <td nowrap='nowrap' align='right'><b>&nbsp; $<?php echo number_format($price+$price*$_POST['tax']/100,2) ?></b></td>
                                                        </tr>
                                                    </tbody></table>
                                                </td>
                                            </tr>
                                        ...
                                        <b>Payment Method:</b>
                                        <br> <?php echo $_POST['Paymentm'] ?>
                                        <nobr> | Last digits: <?php echo $_POST['payment'] ?></nobr>
                                        <br>
...
<table border="0" cellpadding="0" cellspacing="1">
  ...
  <tbody><tr valign="top">
    <td nowrap="nowrap" align="right">
      <?php echo $_POST['Paymentm'] ?> ending in <?php echo $_POST['payment'] ?>:<?php echo $_POST['shipmonth'] . " " . $_POST['shipday'] . ", " . $_POST['shipyear'] ?>
    </td>
    <td nowrap="nowrap" align="right" colspan="2">
      :$<?php echo number_format($price+$price*$_POST['tax']/100,2) ?>
    </td>
  </tr>
</tbody></table>
